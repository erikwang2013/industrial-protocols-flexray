# FlexRay 协议包 — 汽车高速确定性总线，10 Mbps，需 FlexRay 控制器桥接

> [中文](README.md)

FlexRay 协议包 — 汽车高速确定性总线，10 Mbps，需 FlexRay 控制器桥接。Requires dedicated hardware, bridged to vendor SDK or gateway via kernel Bridge layer.

## Installation

```bash
composer require erikwang2013/industrial-protocols-kernel erikwang2013/industrial-protocols-flexray
```
...
$conn = $kernel->getConnectionManager()->connect('device-id', [
    'protocol' => 'flexray', 'bridge' => $bridge,
]);
...
Vector (FlexRay Interface), Bosch (FlexRay Controller), NXP (FlexRay Transceiver)
...
- FlexRay controller and transceiver
